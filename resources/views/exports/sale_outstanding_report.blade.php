...
<body>
    <table id="t01" class="table_no" width="100%" style="table-layout: fixed">
        <thead>
        <tr><th colspan="14" style="text-align: center;"><h3>Sale Outstanding Report</h3></th>
        </tr>
        <tr>
                ...
                @endif
                   @if($c->type=="paid")
                        <tr>
                            ...
                            <td class="text-center">{{$c->cus_name}}</td>
                            <td class="text-center">{{$c->cus_code}}</td>
                            <td class="text-center">{{$c->township_name}}</td>
                            @if(!empty($c->sale_man))
                            <td class="text-center">{{$c->sale_man}}</td>
                            @else
                            <td></td>
                            @endif
                            <td class="text-center">{{$c->cus_phone}}</td>
                            <td>
