...
<body>
    <table id="t01" class="table_no" width="100%" style="table-layout: fixed">
        <thead>
        <tr><th colspan="7" style="text-align: center;"><h3> Collection Report</h3></th>
        </tr>
        <tr>
            ...
            <th class="text-center">Collect Amount({{$request->sign}})</th>
            ...
            @foreach($collections as $cc)
               ...
               @endphp
                        <tr>
                            ...
                            <td class="text-center">{{$cc->customer_name}}</td>
