        ...
        <tbody>
           <?php
            ...
            foreach($data as $r) {
                $i++;
                $html .= '<tr>';
                $html .= '<td style="text-align:right; width:5%">'.$i.'</td>';
                ...
                $html .= '<td class="text-center" style="width:25%">'.$r->product_name.'</td>';

                $html .= '<td class="text-center mm-txt" style="text-align:right;width:7%">'.(int)$r->total_quantity.'</td>';
            ...
            if(!empty($data)) {
                $html .= '<tr><td colspan="5" style="text-align:right">Total</td><td class="text-right" style="text-align:right;">'.number_format($total_qty).'</td><td></td><td class="text-right" style="text-align:right;">'.number_format($total).'</td></tr>';
