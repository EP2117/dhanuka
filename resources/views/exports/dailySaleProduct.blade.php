               ...
               /** foreach($data as $sale) {
                ...
                foreach($data as $k=>$sale) {                
                        ...
                        if($k==0 || $sale->sale_id != $data[$k-1]->sale_id)
                        {
                            ...
                            $html .= '<td class="mm-txt" rowspan="'.$r_count.'" style="min-width:150px;border-right:solid 1px #ccc !important;vertical-align:middle">'.$sale->installer.'</td>';
                            $html .= '<td class="mm-txt" rowspan="'.$r_count.'" style="min-width:150px;border-right:solid 1px #ccc !important;vertical-align:middle">'.$sale->remark.'</td>';
                        } 
                        //$html .= '<td class="mm-txt">'.$sale->office_sale_man.'</td>';
                        $html .= '<td>'.$sale->product_code.'</td>';
                        ...
                        {
                            $html .= '<tr><td colspan ="13" style="text-align: right;">Total</td><td class="text-right" style="text-align: right;">'.number_format($sp_total).'</td></tr>';
                        } 
                } 
                
                $html .= '<tr><td colspan ="13" style="text-align: right;">Total</td><td class="text-right" style="text-align: right;">'.number_format($total).'</td></tr>';
