...
<body>
  ...
  <!--<div>-->
    ...
    <table id="t01" cellpadding="0" cellspacing="0" style="border:none;width:100%;">
      <thead>
        ...
        <td colspan="9" style="border:none;">
            <div style="width:100%; text-align: center;">
              <div style="text-align: center;height: auto;float:left;margin-right: 10px;"><img src="{{url('storage/image/print_logo_new.jpg')}}" width="80" /></div>
        ...
        <tr>
          <td colspan="9" style="border:none;">
            <div>
              <div style="float:left;" class="mm-txt"><b>ဝယ်သူအမည်</b>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  {{$return->customer->cus_name}}</div>
              <div style="float:right" class="mm-txt"><b>ရက်စွဲ</b>&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php
                        $date_arr = explode('-',$return->return_date);
                      ?>
                      {{$date_arr[2].'-'.$date_arr[1].'-'.$date_arr[0]}}
              </div>
            </div>
            <div style="clear: both;">
              <div style="float:left;" class="mm-txt"><b>လိပ်စာ</b>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$return->customer->cus_shipping_address}}</div>
              @if($return->return_method == 'with invoice')
              <div style="float:right" class="mm-txt"><b>ဘောက်ချာ နံပါတ်</b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
              {{$return->sale->invoice_no}}</div>
              @else
              <div style="float:right" class="mm-txt"><b>ဘောက်ချာ နံပါတ်</b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-</div>
              @endif
            </div>
            <div style="clear: both;">
              <div style="float:left;" class="mm-txt"><b>Return Method</b>&nbsp;&nbsp;&nbsp;&nbsp;{{$return->return_method}}</div>
              <div style="float:right" class="mm-txt"><b>Return Number</b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$return->return_no}}</div>
            </div>
          </td>
        </tr>
        <tr class="tr_heigh">
          ...
          <td class='mm-txt' style="text-align: center;font-weight: bold;width:120px;">ဈေးနှုန်း(MMK)</td>
          <td class='mm-txt' style="text-align: center;font-weight: bold;width:150px;">လျှော့ငွေ(%)</td>
          <td class='mm-txt' style="text-align: center;font-weight: bold;width:120px;">သင့်ငွေ</td>
        </tr>
      </thead>
      <?php
      ...
      <tr class="tr_heigh">
        <td colspan="3" rowspan="3" style="vertical-align: top;" class="mm-txt">
          Sales Man: {{$return->office_sale_man->sale_man}} <br /><br />
          <div>
              <div style="float:left" class="mm-txt">User ID: {{ Auth::user()->name }}</div>
              <div style="float:right" class="mm-txt">Signature: .............</div>
          </div>           
        </td>
        <td colspan="2" class="mm-txt" style="padding:0px;padding-left: 5px">Total Amount</td>
        <td style="text-align: right;padding: 0px;padding-right: 5px">{{number_format($return->total_amount)}}</td>
      </tr>
      <tr>
        <td colspan="2" class="mm-txt" style="padding:0px;padding-left: 5px">Return Amount</td>
        <td style="text-align: right;padding: 0px;padding-right: 5px">{{!empty($return->payment_amount) ? number_format($return->payment_amount) : '0'}}</td>
      </tr>
      <tr>
        <td colspan="2" class="mm-txt" style="padding:0px;padding-left: 5px">Balance Amount</td>
        <td style="text-align: right;padding: 0px;padding-right: 5px">{{number_format($return->balance_amount)}}</td>
      </tr>
      <!--<tfoot>
        <tr style="border:none;">
