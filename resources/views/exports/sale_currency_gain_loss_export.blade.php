...
<body>
    <table id="t01" class="table_no" width="100%" style="table-layout: fixed">
        <thead>
        <tr><th colspan="10" class="text-center font-bold mm-txt" style="text-align:center"><b>Sale Currency Gain/Loss Report</b></th></tr>
        <tr>
        ...
        <tbody>
           <?php
            ...
            $net_gain = $net_loss = 0;
            if(!empty($data)) {
                $html .= '<tr><td colspan="11" class="text-right" style="text-align:right;">Total</td><td class="text-right">'.floatval($gain) .'</td><td class="text-right">'.floatval($loss) .'</td></tr>';
                ...
                $html .= '<tr><td colspan="11" class="text-right" style="text-align:right">Net Total</td><td class="text-right">'.$net_gain.'</td><td class="text-right">'.$net_loss.'</td></tr>';
