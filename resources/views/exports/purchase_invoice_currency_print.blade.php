    ...
    <table id="t01" cellpadding="0" cellspacing="0" style="border:none;width:100%;">
      <thead>
        ...
        <tr class="tr_heigh">
          ...
          <td class='mm-txt' style="text-align: center;font-weight: bold;width:150px;">ဈေးနှုန်း({{$currency}})</td>
          <td class='mm-txt' style="text-align: center;font-weight: bold;width:150px;">သင့်ငွေ({{$currency}})</td>
        </tr>
      </thead>
      <?php
