...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <hr class="sidebar-divider">
    ...
    @if( Request::path() != '/')
        ...
        <router-link  tag="li" to="/installer" class="nav-item">
            <a class="nav-link" >
                <i class="fas fa-users"></i>
                <span>Installer</span>
            </a>
    ...
    <!-- Nav Item - Pages Collapse Menu -->
        ...
        @if(Request::path() != 'van' && (Auth::user()->role->id == 1 || Auth::user()->role->id == 2 || Auth::user()->role->id == 3 || Auth::user()->role->id == 9))
            <hr class="sidebar-divider">
    ...
    @if(Auth::user()->role->role_name == 'system' || Auth::user()->role->role_name == 'admin' || Auth::user()->role->id == 19 || Auth::user()->role->id == 10 || Auth::user()->role->id == 11 || Auth::user()->role->id == 14 || Auth::user()->role->id == 18 || Auth::user()->role->id == 9)
    <hr class="sidebar-divider">
    ...
    @if(Auth::user()->role->role_name == 'system' || Auth::user()->role->role_name == 'admin' || Auth::user()->role->id == 19 || Auth::user()->role->id == 12 || Auth::user()->role->id == 14 || Auth::user()->role->id == 9)
    <hr class="sidebar-divider">
    ...
    @if(Auth::user()->role->role_name == 'system' || Auth::user()->role->role_name == 'admin' || Auth::user()->role->id == 19 || Auth::user()->role->id == 10 || Auth::user()->role->id == 11 || Auth::user()->role->id == 13 || Auth::user()->role->id == 14 || Auth::user()->role->id == 18 || Auth::user()->role->id == 9)
    <hr class="sidebar-divider">
    ...
    @if(Auth::user()->role->role_name == 'system' || Auth::user()->role->role_name == 'admin' || Auth::user()->role->id == 19 || Auth::user()->role->id == 15 || Auth::user()->role->id == 9)
    <hr class="sidebar-divider">
    ...
    @if(Auth::user()->role->role_name == 'system' || Auth::user()->role->role_name == 'admin' || Auth::user()->role->id == 19 || Auth::user()->role->id == 15 || Auth::user()->role->id == 16 || Auth::user()->role->id == 9)
    <hr class="sidebar-divider">
