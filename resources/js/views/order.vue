<template>
    <div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <router-link :to="'/order/new'" class="d-sm-inline-block btn btn-primary shadow-sm inventory" v-if='user_role == "system" || user_role == "office_user" || user_role == "office_order_user" || user_role == "Local Supervisor" || user_role == "Account"'>
