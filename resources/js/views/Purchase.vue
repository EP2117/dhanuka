<template>
    <div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <router-link :to="'/purchase/'+purchase_type+'/create'" class="d-sm-inline-block btn btn-primary shadow-sm inventory" v-if="user_role == 'system' || user_role == 'admin' || user_role == 'van_user'">
...
<!--                            <th class="text-center" v-if="sale_type == 1">Delivery Approve</th>-->
                        ...
                        <template v-for="(p,index) in purchases.data">
                            <tr>
                                ...
                                <td v-if="p.branch != null">{{p.branch_name}}</td>
                                <td v-else></td>
                                <td class="mm-txt">{{p.supplier_name}}</td>
                                <td class="mm-txt" v-if="p.office_purchase_man_id != null">{{p.purchase_man}}</td>
                                <td v-else></td>
