                    ...
                    <form class="form" id="sale_form" method="post" @submit.prevent="onSubmit" @keydown="form.errors.clear($event.target.name)">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                >
                                    <option v-for="sale in sale_invoices" :value="sale.id" :data-balance="sale.balance_amount-(sale.collection_amount+sale.return_amount+sale.customer_return_amount)">{{sale.invoice_no}}_{{(sale.balance_amount-(sale.collection_amount+sale.return_amount+sale.customer_return_amount)).toLocaleString()}}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" v-if="isEdit"> 
                                <input type="submit" class="btn btn-primary btn-sm" value="Update" id="save_btn" v-if="user_role != 'Account'">
                            </div>
