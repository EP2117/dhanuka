<template>
    <div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <router-link :to="'/sale/'+sale_type+'/new'" class="d-sm-inline-block btn btn-primary shadow-sm inventory" v-if="user_role == 'system' || user_role == 'office_user' || user_role == 'van_user' || user_role == 'Account'">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-lg-3 mm-txt">
                        ...
                        <select id="installer_id" class="form-control mm-txt"
                            name="installer_id" v-model="search.installer_id" style="width:100%" required
                        >
                            <option value="">Select One</option>
                    ...
                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Installation By</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td v-else></td>
                                <td class="mm-txt" v-if="sale.installer_id != null">{{sale.installer.name}}</td>
                                <td v-else></td>
                                ...
                                <td class="mm-txt">{{sale.remark}}</td>
    ...
    export default {
        ...
        mounted() {
            ...
            $("#installer_id").on("select2:select", function(e) {
                ...
                var data = e.params.data;
                app.search.installer_id = data.id;
            });
