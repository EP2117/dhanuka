    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">PurchaseCurrency Gain/Loss Report</li>

            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Purchase Currency Gain/Loss Report</h4>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Purchase Currency Gain/Loss List</h6>
            </div>
            <div class="card-body">
        ...
        methods: {
           ...
           /** initUsers() {
            ...
            getCurrencyGainLoss(page = 1) {
                ...
                axios.get("/currency_gain_loss_report?" + search)
            ...
            exportExcel() {    
              ...
              var search =
                ...
                //window.open(baseurl+'/currency_gain_loss_export?'+search);
                window.open(this.site_path+'/currency_gain_loss_export?'+search);
            },
        },
