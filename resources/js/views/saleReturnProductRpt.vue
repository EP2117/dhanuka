    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sale Return Product Report</li>

            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Sale Return Product Report</h4>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Sale Return Product List</h6>
            </div>
            <div class="card-body">
        ...
        methods: {
           ...
           /** initUsers() {
            ...
            getSaleReturnProduct(page = 1) {
                ...
                axios.get("/sale_return_product_report?" + search)
            ...
            exportExcel() {    
              ...
              var search =
                ...
                //window.open(baseurl+'/sale_return_product_export?'+search);
                window.open(this.site_path+'/sale_return_product_export?'+search);
            },
        },
