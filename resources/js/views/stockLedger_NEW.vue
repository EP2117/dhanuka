<template>
 ...
 <!-- Kamlesh End -->
                    ...
                    <!--<table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">-->
                        ...
                        <tbody>
                            <template v-for="(d ,index) in products">
                                <template v-for="(p,i) in d">
                                <tr >
                                    <td>{{p.date}}</td>
                                    <td>{{p.opening.brand_name}}</td>
                                    <td>{{p.opening.product_code}}</td>
                                    <td>{{p.opening.product_name}}</td>
                                    <td></td>

                                    <td></td>

                                    <td>{{parseInt(p.opening.in_qty) - parseInt(p.opening.out_qty)}}</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr v-for="(t ,j) in p.transitions">
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td v-if="t.transition_return_id == null">{{t.invoice_no}}</td>
                                    <td v-else>{{t.return_invoice_no}}</td>

                                    <td v-if="t.transition_sale_id != null"> 
                                        <!--Sale Invoice--> {{t.sale_customer_name}} - {{t.invoice_no}}
                                    </td>
                                    <td v-else-if="t.transition_purchase_id != null">
                                        <!-- Purchase Invoice --> {{t.purchase_reference_no}} - {{t.invoice_no}}
                                     </td>
                                    <td v-else-if="t.transition_entry_id != null"> 
                                        <!--Main Warehouse Entry --> {{t.entry_reference_no}} - {{t.invoice_no}}
                                    </td>
                                    <td v-else-if="t.transition_adjustment_id != null"> 
                                        <!--Inventory Adjustment--> {{t.adjustment_reference_no}} - {{t.invoice_no}}
                                    </td>
                                    <td v-else-if="t.transition_transfer_id != null && t.transition_type == 'out'"> Transfer</td>
                                    <td v-else-if="t.transition_transfer_id != null && t.transition_type == 'in'"> Receive from Tranfer</td>
                                    <td v-else-if="t.transition_return_id != null"> 
                                        <!--Sale Return-->{{t.return_customer_name}} - {{t.return_invoice_no}}
                                    </td>

                                    <td></td>

                                    <td>{{t.transition_entry_id != null || t.transition_purchase_id != null ? t.product_quantity : ''}}</td>
                                    <td>{{t.transition_transfer_id != null && t.transition_type == 'in' ? t.product_quantity : ''}}</td>
                                    <td>{{t.transition_transfer_id != null && t.transition_type == 'out' ? t.product_quantity : ''}}</td>
                                    <td>{{t.transition_sale_id != null && t.transition_return_id == null ? t.product_quantity : ''}}</td>
                                    <td>{{t.transition_return_id != null ? t.product_quantity : ''}}</td>
                                    <td>{{t.transition_adjustment_id != null ? t.product_quantity : ''}}</td>
                                </tr>
                                <tr>
        ...
        methods: {
                    ...
                    /*$.each(app.products, function(index, value) {
                        ...
                        $.each(value, function(i, p) {
                            ...
                            if(p.transitions.length > 0) {
                                $.each(p.transitions, function(j, t) {
                                    console.log(t.product_quantity);
                                });
                            }
                        });
                    });*/
            ...
            getClosing(id,t_date) {
                ...
                products.forEach((p)=> {
                   ...
                   else if(p.transition_sale_id != null && p_date <= t_date) {
            ...
            exportExcel() {
                ...
                window.open(this.site_path+'/stock_ledger_export?'+search);
            },
