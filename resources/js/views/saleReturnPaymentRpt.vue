    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Return Payment Report</li>

            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Return Payment Report</h4>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-lg-3">
                        <label for="payment_no">Return Payment Number</label>
                        <input type="text" class="form-control" id="payment_no" name="payment_no" v-model="search.payment_no">
                    </div>

                    <div class="form-group col-md-4 col-lg-3">
                        <label for="from_date">Return Payemnt From Date</label>
                        <input type="text" class="form-control datetimepicker" id="from_date" name="from_date"
                        v-model="search.from_date">
                    </div>

                    <div class="form-group col-md-4 col-lg-3">
                        <label for="to_date">Return Payment To Date</label>
    ...
    export default {
        ...
        mounted() {
            ...
            .on("dp.show", function(e) {
                ...
                app.search.return_date = moment().format('YYYY-MM-DD');
                if(app.user_year < y) { 
                  if(app.search.return_date == app.user_year+"-12-31" || app.search.return_date == '') {
                    app.search.return_date = app.user_year+"-12-31";
                  }
                }
            })
            .on("dp.change", function(e) {
                ...
                app.search.return_date = formatedValue;
            });
        ...
        methods: {
           ...
           /** initUsers() {
            ...
            getSaleReturnPayment(page = 1) {
                ...
                axios.get("/sale_return_payment_report?" + search)
            ...
            exportExcel() {    
              ...
              var search =
                ...
                //window.open(baseurl+'/sale_return_payment_export?'+search);
                window.open(this.site_path+'/sale_return_payment_export?'+search);
            },
        },
