    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Return OS Report</li>

            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Return OS Report</h4>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Return OS List</h6>
            </div>
            <div class="card-body">
        ...
        methods: {
           ...
           /** initUsers() {
            ...
            getSaleReturnOS(page = 1) {
                ...
                axios.get("/sale_return_os_report?" + search)
            ...
            exportExcel() {    
              ...
              var search =
                ...
                //window.open(baseurl+'/sale_return_os_export?'+search);
                window.open(this.site_path+'/sale_return_os_export?'+search);
            },
        },
