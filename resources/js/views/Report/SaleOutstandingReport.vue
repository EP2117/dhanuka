                        ...
                        <tbody id="result" >
                            <template v-for="(po,k) in sale_outstandings">
                                ...
                                <tr v-if="c.type=='paid' && c.due_date != null && c.due_date <c.current_date" style="background:#F3C1C2;">
                                    ...
                                    <td class="text-center" style="right: 4px ">{{c.cus_code}}</td>
                                    <td class="text-center mm-txt">{{c.township_name}}</td>
                                    <td class="mm-txt textalign" v-if="c.office_sale_man_id != null">{{c.sale_man}}</td>
                                    <td v-else></td>
