<template>
    <div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Customer Return</h4>
            <router-link :to="'/customer_return/new'" class="d-sm-inline-block btn btn-primary shadow-sm inventory">
                <i class="fas fa-plus"></i> Add Customer Return
            </router-link>
        </div>
                    ...
                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="textalign">{{sreturn.customer_return_no}}</td>
                                <td class="textalign">{{sreturn.return_date}}</td>
                                <td class="mm-txt">{{sreturn.customer.cus_name}}</td>
                                <td class="text-right">{{sreturn.return_amount}}</td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item">
                                                <router-link tag="span" :to="'/customer_return/edit/' + sreturn.id">
                                            ...
                                            <a class="dropdown-item">
                                                <a title="Delete" class="text-danger" @click="removeReturn(sreturn.id)" v-if="user_role != 'Account'">
    ...
    export default {
        ...
        methods: {
            ...
            getReturns(page = 1) {
                ...
                axios.get("/customer_return?page=" + page + search).then(function(response) {
                    $("#loading").hide();
            ...
            removeReturn(id) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        axios.delete("/customer_return/" + id).then(function() {
                            app.getReturns();
                        });
                        swal("Success! Customer Return has been deleted!", {
                            icon: "success"
                        });   
                    } else {
                      //
