<template>
    <div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3" v-if="user_role == 'admin'">
                    ...
                    <form class="form" method="post" @submit.prevent="onSubmit" >
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <select id="role_id" class="form-control mm-txt"
                                    name="role_id" v-model="form.role_id" style="width:100%" :disabled="isReadOnly"
                                >
                        ...
                        <div class="row branch_div" style="display:none;">
                            <div class="form-group col-md-4">
                                ...
                                <select id="branch_id" class="form-control mm-txt"
                                    name="branch_id" v-model="form.branch_id" style="width:100%" :disabled="isReadOnly"
                                >
                                    <option value="">Select One</option>
                        ...
                        <div class="row branches_div" style="display:none;">
                            <div class="form-group col-md-8">
                                ...
                                <select multiple class="form-control branches"
                                    name="branches[]" v-model="form.branches" style="width:100%" :disabled="isReadOnly"
                                >
                                    <option v-for="branch in branches" :value="branch.id">{{branch.branch_name}}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name" :readonly="isReadOnly" v-model="form.name" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" id="email" name="email" v-model="form.email" :readonly="isReadOnly">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <select id="warehouse_id" class="form-control"
                                    name="warehouse_id" v-model="form.warehouse_id" style="width:100%" :disabled="isReadOnly" required
                                >
                                    <option value="">Select One</option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" v-model="form.phone" :readonly="isReadOnly">
                            </div>
                        </div>
                        ...
                        <div class="row country_head_div" style="display:none;">
                            <div class="form-group col-md-8">
                                ...
                                <select multiple class="form-control local_supervisors"
                                    name="local_supervisors[]" v-model="form.local_supervisors" style="width:100%" :disabled="isReadOnly"
                                >
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <select multiple class="form-control office_sale_man"
                                    name="office_sale_man[]" v-model="form.office_sale_man" style="width:100%" :disabled="isReadOnly"
                                >
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <select multiple class="form-control brands"
                                    name="brands[]" v-model="form.brands" style="width:100%" :disabled="isReadOnly"
                                >
                        ...
                        <div class="row local_supervisor_div" style="display:none;">
                            <div class="form-group col-md-8">
                                ...
                                <select multiple class="form-control so_man"
                                    name="so_man[]" v-model="form.so_man"style="width:100%" :disabled="isReadOnly"
                                >
    ...
    export default {
        ...
        methods: {
            ...
            getUser(id) {
              let app = this;
              $("#loading").show();
              app.isReadOnly = app.user_role == 'system' ? false : true;
              axios
                .get("/user/" + id)
