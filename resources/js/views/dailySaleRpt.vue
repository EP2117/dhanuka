            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-lg-3">
                        ...
                        <input type="text" class="form-control" id="remark" name="remark" v-model="search.remark">
                    </div>
                        ...
                        <tbody>
                            <template v-for="sale in sales">
                                <tr>
                                    ...
                                    <td class="mm-txt textalign" v-if="sale.installer_id != null">{{sale.installer.name}}</td>
                                            <td v-else></td>
                                    <td class="mm-txt textalign">{{sale.remark}}</td>
