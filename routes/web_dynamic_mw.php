...
Route::get('/', function () {return view('home');})->middleware('auth','dynamic');
Route::get('/master/', function () {return view('module_vw');})->middleware('auth','dynamic');
Route::get('/van/', function () {return view('module_vw');})->middleware('auth','dynamic');
Route::get('/office/', function () {return view('module_vw');})->middleware('auth','dynamic');
Route::get('/account/', function () {return view('module_vw');})->middleware('auth','dynamic');
Route::get('/purchase_office', function () {return view('module_vw');})->middleware('auth','dynamic');
Route::get('/inventory/', function () {return view('module_vw');})->middleware('auth','dynamic');
Route::get('/report/', function () {return view('module_vw');})->middleware('auth','dynamic');

Route::get('/test', 'ProductTransitionController@test');

Route::group(['prefix' => '',  'middleware' => ['auth', 'dynamic']], function () {
