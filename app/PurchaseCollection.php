...
class PurchaseCollection extends Model
{
    ...
    protected $fillable=['supplier_id','collection_no','collection_date','branch_id','auto_payment','currency_id','currency_rate','total_paid_amount','total_paid_amount_fx','created_at','updated_at','created_by','updated_by'];
