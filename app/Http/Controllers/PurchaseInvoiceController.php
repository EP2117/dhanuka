...
class PurchaseInvoiceController extends Controller
{
    ...
    public function index(Request  $request){
        ...
        $data = DB::table("purchase_invoices")
                ...
                ->select(DB::raw("purchase_invoices.*, branches.branch_name, suppliers.name as supplier_name, currencies.sign, warehouses.warehouse_name, purchase_men.name as purchase_man"))
                ...
                ->leftjoin('warehouses', 'warehouses.id', '=', 'purchase_invoices.warehouse_id')
                ->leftjoin('users as purchase_men', 'purchase_men.id', '=', 'purchase_invoices.office_purchase_man_id')
                ->where('is_opening',0);
