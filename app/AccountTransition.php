...
class AccountTransition extends Model
{
    ...
    protected $fillable=['transition_date','sub_account_id','account_group_id','cash_bank_sub_account_id','receipt_id','payment_id','supplier_id','customer_id','purchase_id','purchase_advance_id','sale_id','return_id','customer_return_id','return_payment_id','sale_advance_id','journal_entry_id','inventory_adjustment_id','credit','debit','is_cashbook','vochur_no','description','status','created_by','updated_by'];
